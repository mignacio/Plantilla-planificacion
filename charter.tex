...
\item El montaje de la tablet en la cabina del vehículo.
...
\item Se cuenta con una tablet con pantalla táctil, puerto micro USB-OTG y que corre sistema operativo Android.
...
\item Requerimientos generales del proyecto:
	...
	\item \textbf{REQ-GEN-002:} La documentación del código fuente será llevada a cabo en comentarios del mismo, siguiendo el formato de Doxygen.
	\end{itemize}
\item Grupo de la interfaz gráfica de usuario:
	\begin{itemize}
	...
	\end{itemize}
\item Grupo del hardware adquisidor de datos:
	\begin{itemize}
	...
	\item REQ-ADQ-005: El sistema debe transmitir a la interfaz gráfica la información obtenida de los sensores
	\end{itemize}
\end{itemize}
...
\item \textbf{Planificación.} (60 hs)
	...
	\item Espeficicación de requerimientos de sistema. (20 hs)
...
\item \textbf{Diseño y construcción del hardware del equipo.} (65 hs)
	...
	\end{enumerate}
\item \textbf{Diseño de la interfaz gráfica.} (
	\begin{enumerate}
	\item Diseño de la arquitectura de software. (tantas hs)
	\item Maquetación de la interfaz gráfica. (tantas hs)
	\item Desarrollo del software. (tantas hs)
	\item Pruebas de verificación. (tantas hs)
	\item Modificaciones del software. (tantas hs)
	\item Segunda ronda de pruebas de verificación. (tantas hs).
	\end{enumerate}
\item \textbf{Diseño e implementación del firmware} (tantas hs).
	\begin{itemize}
	\item Diseño de la arquitectura de software.
	\item Familiarización con el entorno de desarrollo.
	\item Diseño del módulo adquisidor de temperatura.
	\item Diseño del módulo adquisidor de presión de aceite.
	\item Diseño del módul adquisidor de relación de oxígeno.
	\item Diseño del módulo de transmisión de datos.
	\
	\end{itemize}
\end{enumerate}
