...
\begin{enumerate}
\item Grupo de requerimientos asociados con la interfaz gráfica
	\begin{enumerate}
	\item REQ-GUI-001: La interfaz gráfica deberá poder mostrar gráficas con la información de todos los sensores a la vez.
	\item REQ-GUI-002: El usuario tiene que poder elegir que sensores ver al mismo tiempo y cuáles no desea ver.
	\item REQ-GUI-003: El usuario tiene que poder elegir
	\end{enumerate}
\item Grupo de requerimientos asociados con la parte adquisidora
	\begin{enumerate}
	\item Los rangos de los sensores de temperatura tiene que estar entre 0C y 200C. Con una resolución menor o igual a 0,25C
	\item El rango de presión de aceite tiene que ser entre 1 y 100 PSI. Con una resolución menor o igual a 0,25C PSI
...
\item Documentación del software
